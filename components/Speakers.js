...
const Speakers = () => {
  ...
  return (
    <div className="p-5 flex flex-col items-center gap-10 mt-16">
      ...
      <div className="space-y-5 text-center w-11/12">
        <p className="text-xl">
        ...
        <p className="text-xl">
          Stay tuned for our speaker announcements—you won’t want to miss the
          chance to hear from these extraordinary minds!
        </p>
      </div>
